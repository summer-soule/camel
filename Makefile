...
p7s1e1=$(BUILDDIR)/part7/section1/ex1

p7s2e2=$(BUILDDIR)/part7/section2/ex2
p7s2e3=$(BUILDDIR)/part7/section2/ex3

p7s3e4=$(BUILDDIR)/part7/section3/ex4
p7s3e5=$(BUILDDIR)/part7/section3/ex5
p7s3e6=$(BUILDDIR)/part7/section3/ex6
p7s3e7=$(BUILDDIR)/part7/section3/ex7
p7s3e8=$(BUILDDIR)/part7/section3/ex8

p7s4e9=$(BUILDDIR)/part7/section4/ex9
p7s4e10=$(BUILDDIR)/part7/section4/ex10
p7s4e11=$(BUILDDIR)/part7/section4/ex11
p7s4e12=$(BUILDDIR)/part7/section4/ex12
p7s4e13=$(BUILDDIR)/part7/section4/ex13
p7s4e14=$(BUILDDIR)/part7/section4/ex14

p7s5e15=$(BUILDDIR)/part7/section5/ex15
...
p6proj3=$(BUILDDIR)/part6/projects/project3
p6proj4=$(BUILDDIR)/part6/projects/project4
p6proj5=$(BUILDDIR)/part6/projects/project5
p6proj6=$(BUILDDIR)/part6/projects/project6
p6proj7=$(BUILDDIR)/part6/projects/project7
p6proj8=$(BUILDDIR)/part6/projects/project8
p6proj9=$(BUILDDIR)/part6/projects/project9
p6proj10=$(BUILDDIR)/part6/projects/project10
p6proj11=$(BUILDDIR)/part6/projects/project11
p6proj12=$(BUILDDIR)/part6/projects/project12

p7proj1=$(BUILDDIR)/part7/projects/project1
p7proj2=$(BUILDDIR)/part7/projects/project2
p7proj3=$(BUILDDIR)/part7/projects/project3
p7proj4=$(BUILDDIR)/part7/projects/project4
p7proj5=$(BUILDDIR)/part7/projects/project5
p7proj6=$(BUILDDIR)/part7/projects/project6
p7proj7=$(BUILDDIR)/part7/projects/project7
p7proj8=$(BUILDDIR)/part7/projects/project8
...
p7proj13=$(BUILDDIR)/part7/projects/project13
p7proj14=$(BUILDDIR)/part7/projects/project14
p7proj15=$(BUILDDIR)/part7/projects/project15
...
PART7 = $(p7s1e1) $(p7s2e2) $(p7s2e3) $(p7s3e4) $(p7s3e5) $(p7s3e6) $(p7s3e7) $(p7s3e8) $(p7s4e9) $(p7s4e10) $(p7s4e11) $(p7s4e12) $(p7s4e13) $(p7s4e14) $(p7s5e15) $(p7proj1) $(p7proj2) $(p7proj3) $(p7proj4) $(p7proj5) $(p7proj6) $(p7proj7) $(p7proj8) $(p7proj9) $(p7proj10) $(p7proj11) $(p7proj12) $(p7proj13) $(p7proj14) $(p7proj15)
...
$(p7s1e1): $(SRCDIR)/part7/section1/ex1.c | $(BUILDDIR)
	$(CC) $(CFLAGS89) $^ -o $@

$(p7s2e2): $(SRCDIR)/part7/section2/ex2.c | $(BUILDDIR)
	$(CC) $(CFLAGS89) $^ -o $@

$(p7s2e3): $(SRCDIR)/part7/section2/ex3.c | $(BUILDDIR)
	$(CC) $(CFLAGS89) $^ -o $@

$(p7s3e4): $(SRCDIR)/part7/section3/ex4.c | $(BUILDDIR)
	$(CC) $(CFLAGS89) $^ -o $@

$(p7s3e5): $(SRCDIR)/part7/section3/ex5.c | $(BUILDDIR)
	$(CC) $(CFLAGS89) $^ -o $@

$(p7s3e6): $(SRCDIR)/part7/section3/ex6.c | $(BUILDDIR)
	$(CC) $(CFLAGS89) $^ -o $@

$(p7s3e7): $(SRCDIR)/part7/section3/ex7.c | $(BUILDDIR)
	$(CC) $(CFLAGS89) $^ -o $@

$(p7s3e8): $(SRCDIR)/part7/section3/ex8.c | $(BUILDDIR)
	$(CC) $(CFLAGS89) $^ -o $@

$(p7s4e9): $(SRCDIR)/part7/section4/ex9.c | $(BUILDDIR)
	$(CC) $(CFLAGS89) $^ -o $@

$(p7s4e10): $(SRCDIR)/part7/section4/ex10.c | $(BUILDDIR)
	$(CC) $(CFLAGS89) $^ -o $@

$(p7s4e11): $(SRCDIR)/part7/section4/ex11.c | $(BUILDDIR)
	$(CC) $(CFLAGS89) $^ -o $@

$(p7s4e12): $(SRCDIR)/part7/section4/ex12.c | $(BUILDDIR)
	$(CC) $(CFLAGS89) $^ -o $@

$(p7s4e13): $(SRCDIR)/part7/section4/ex13.c | $(BUILDDIR)
	$(CC) $(CFLAGS89) $^ -o $@

$(p7s4e14): $(SRCDIR)/part7/section4/ex14.c | $(BUILDDIR)
	$(CC) $(CFLAGS89) $^ -o $@

$(p7s5e15): $(SRCDIR)/part7/section5/ex15.c | $(BUILDDIR)
	$(CC) $(CFLAGS89) $^ -o $@
...
$(p6proj3): $(SRCDIR)/part6/projects/project3.c | $(BUILDDIR)
	$(CC) $(CFLAGS99) $^ -o $@

$(p6proj4): $(SRCDIR)/part6/projects/project4.c | $(BUILDDIR)
	$(CC) $(CFLAGS99) $^ -o $@

$(p6proj5): $(SRCDIR)/part6/projects/project5.c | $(BUILDDIR)
	$(CC) $(CFLAGS99) $^ -o $@

$(p6proj6): $(SRCDIR)/part6/projects/project6.c | $(BUILDDIR)
	$(CC) $(CFLAGS99) $^ -o $@

$(p6proj7): $(SRCDIR)/part6/projects/project7.c | $(BUILDDIR)
	$(CC) $(CFLAGS99) $^ -o $@

$(p6proj8): $(SRCDIR)/part6/projects/project8.c | $(BUILDDIR)
	$(CC) $(CFLAGS99) $^ -o $@

$(p6proj9): $(SRCDIR)/part6/projects/project9.c | $(BUILDDIR)
	$(CC) $(CFLAGS99) $^ -o $@

$(p6proj10): $(SRCDIR)/part6/projects/project10.c | $(BUILDDIR)
	$(CC) $(CFLAGS99) $^ -o $@

$(p6proj11): $(SRCDIR)/part6/projects/project11.c | $(BUILDDIR)
	$(CC) $(CFLAGS99) $^ -o $@

$(p6proj12): $(SRCDIR)/part6/projects/project12.c | $(BUILDDIR)
	$(CC) $(CFLAGS99) $^ -o $@

$(p7proj1): $(SRCDIR)/part7/projects/project1.c | $(BUILDDIR)
	$(CC) $(CFLAGS99) $^ -o $@

$(p7proj2): $(SRCDIR)/part7/projects/project2.c | $(BUILDDIR)
	$(CC) $(CFLAGS99) $^ -o $@

$(p7proj3): $(SRCDIR)/part7/projects/project3.c | $(BUILDDIR)
	$(CC) $(CFLAGS99) $^ -o $@

$(p7proj4): $(SRCDIR)/part7/projects/project4.c | $(BUILDDIR)
	$(CC) $(CFLAGS99) $^ -o $@

$(p7proj5): $(SRCDIR)/part7/projects/project5.c | $(BUILDDIR)
	$(CC) $(CFLAGS99) $^ -o $@

$(p7proj6): $(SRCDIR)/part7/projects/project6.c | $(BUILDDIR)
	$(CC) $(CFLAGS99) $^ -o $@

$(p7proj7): $(SRCDIR)/part7/projects/project7.c | $(BUILDDIR)
	$(CC) $(CFLAGS99) $^ -o $@

$(p7proj8): $(SRCDIR)/part7/projects/project8.c | $(BUILDDIR)
	$(CC) $(CFLAGS99) $^ -o $@

$(p7proj9): $(SRCDIR)/part7/projects/project9.c | $(BUILDDIR)
	$(CC) $(CFLAGS99) $^ -o $@

$(p7proj10): $(SRCDIR)/part7/projects/project10.c | $(BUILDDIR)
	$(CC) $(CFLAGS99) $^ -o $@
...
$(p7proj13): $(SRCDIR)/part7/projects/project13.c | $(BUILDDIR)
	$(CC) $(CFLAGS99) $^ -o $@

$(p7proj14): $(SRCDIR)/part7/projects/project14.c | $(BUILDDIR)
	$(CC) $(CFLAGS99) $^ -o $@

$(p7proj15): $(SRCDIR)/part7/projects/project15.c | $(BUILDDIR)
	$(CC) $(CFLAGS99) $^ -o $@
...
$(BUILDDIR):
	...
	mkdir -p $(BUILDDIR)/part7/section{1..5}
	mkdir -p $(BUILDDIR)/part7/projects
