...
p3s1e4=$(BUILDDIR)/part3/section2/ex4
...
# Targets
TARGETS=$(p2s1e1) $(p2s2e2) $(p2s2e3) $(p2s2e4) $(p2proj1) $(p2proj2) $(p2proj3) $(p2proj4) $(p2proj5) $(p2proj6) $(p2proj7) $(p2proj8) $(p3s1e1) $(p3s1e2) $(p3s1e4)
...
$(p3s1e4): $(SRCDIR)/part3/section2/ex4.c | $(BUILDDIR)
	$(CC) $(CFLAGS) $^ -o $@
