...
$(BINDIR)/part21/section2/ex7
$(BINDIR)/part22/section1/ex1
$(BINDIR)/part22/section2/ex2
$(BINDIR)/part22/section4/ex9
$(BINDIR)/part24/section1/ex1
endef
...
$(BINDIR)/part23/section4/ex2: LDLIBS += -lm
$(BINDIR)/part23/projects/project1: LDLIBS += -lm
$(BINDIR)/part23/projects/project5: LDLIBS += -lm
$(BINDIR)/part24/section2/ex4: LDLIBS += -lm
$(BINDIR)/part27/section5/ex4: LDLIBS += -lm
$(BINDIR)/part27/projects/project1: LDLIBS += -lm
$(BINDIR)/part27/projects/project2: LDLIBS += -lm
$(BINDIR)/part27/projects/project3: LDLIBS += -lm
$(BINDIR)/part27/projects/project4: LDLIBS += -lm
