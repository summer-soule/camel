...
PART7 = $(p7s1e1) $(p7s2e2) $(p7s2e3) $(p7s3e4) $(p7s3e5) $(p7s3e6) $(p7s3e7) $(p7s3e8) $(p7s4e9) $(p7s4e10) $(p7s4e11) $(p7s4e12) $(p7s4e13) $(p7s4e14) $(p7s5e15) $(p7proj1) $(p7proj2) $(p7proj3) $(p7proj4) $(p7proj5) $(p7proj6) $(p7proj7) $(p7proj8)
