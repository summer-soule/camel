...
PART5 = $(p5s1e1) $(p5s1e2) $(p5s1e3) $(p5s1e4) $(p5s2e5) $(p5s2e6) $(p5s2e7) $(p5s2e8) $(p5s2e9) $(p5s3e10) $(p5s3e11) $(p5proj1) $(p5proj2) $(p5proj3) $(p5proj4) $(p5proj5) $(p5proj6) $(p5proj7) $(p5proj8) $(p5proj9) $(p5proj10)
