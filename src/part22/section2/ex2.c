 ...
 *
 * Task:
 *		Indicate which mode string is most likely to be passed to fopen
 *		in each of the following situations:
 *
 *		(a) A database management system opens a file containing
 *			records to be updated.
 *		(b) A mail program opens a file of saved messages so that it
