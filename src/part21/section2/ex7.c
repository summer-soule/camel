 ...
 *
 * Task:
 *		In which standard header would you expect to find each
 *		of the following?
 *
 ...
 *		(d) A function that rounds a floating-point number to
 *			the next higher integer
 *		(e) A macro that specifies the number of bits in a character
 *		(f) A macro that specifies the number of significant digits
 *			in a double value
