 ...
 * Project 4.
 *
 * Task: Modify the poker.c program of Section 10.5 by having it recognize
 * an additional category, "royal flush" (ace, king, queen, jack, ten of the
...
void analyze_hand(int num_in_rank[NUM_RANKS], int num_in_suit[NUM_SUITS])
{
	...
	for (rank = 0; rank < NUM_RANKS; rank++) {
		...
		&&	num_in_rank[10] == 1
		&&	num_in_rank[11] == 1
		&&	num_in_rank[11] == 1) royal_flush = true;
